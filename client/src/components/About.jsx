  ...
  return (
    <div className="p-5" id="about">
      ...
      <div className="row about-content">
        ...
        >
          <p>
            <span style={{ fontSize: "25px" }}>H</span>i, I'm Poovarasan, a
            passionate third-year B.Tech student specializing in Information
            Technology at Hindusthan College of Engineering and Technology,
            Coimbatore.
          </p>
          <p>
            <span style={{ fontSize: "25px",paddingRight:'8px' }}>I</span>firmly believe that no
            challenge is insurmountable; if I take on a task, I dedicate myself
            wholeheartedly to solving it, no matter how complex it may seem. My
            coding journey began during my college days when I developed a keen
            interest in web technologies, and since then, I've been continuously
            expanding my skills.
          </p>
          <p>
            <span style={{ fontSize: "25px" }}>C</span>urrently, I'm focused on
            seamlessly creating projects that help me implement and refine what
            I've learned. Looking ahead, my dream is to collaborate with expert
            teams to gain deeper insights and grow as a professional.
          </p>
        </div> */}
        <div
          className="col-12 col-md-9 col-lg-8"
        ...
        <div className="col d-flex justify-content-end justify-content-lg-center position-relative about-image-container">
